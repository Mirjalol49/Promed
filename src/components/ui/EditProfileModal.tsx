                ...
                {isOpen && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        <motion.div
                            ...
                            className="relative bg-white w-full max-w-[440px] rounded-2xl shadow-modal border border-slate-100 overflow-hidden max-h-[90vh] overflow-y-auto flex flex-col"
