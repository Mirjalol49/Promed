                            ...
                            <div className="flex-1 overflow-y-auto no-scrollbar p-6">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <motion.button whileTap={{ scale: 0.98 }} transition={{ type: "spring", stiffness: 800, damping: 35 }}
                                        onClick={onClose}
                                        className="p-2 -mr-1 bg-slate-100 hover:bg-slate-200 text-slate-400 rounded-full transition-colors self-start"
                                    >
                                    ...
                                    <div>
                                        ...
                                        <CustomSelect
                                            options={[
                                                ...
                                                { value: 'salary', label: t('salary') || 'Salary' }
                                            ]}
                                            value={category}
                                            onChange={(v) => setCategory(v as TransactionCategory)}
                                        />
                                    </div>
